...
export default function ServicesContent() {
  return (
    <div>
      ...
      <StaggerContainer className="grid md:grid-cols-1 lg:grid-cols-3 gap-8">
        {services.map((service) => (
          <StaggerItem key={service.title} className="bg-white p-8 rounded-lg shadow-md flex flex-col transition-all duration-300 hover:shadow-xl hover:-translate-y-2">
